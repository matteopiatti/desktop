...
export function getSolitaire() {
    ...
    gameEl.classList.add('solitaire');
    gameEl.id = 'js-solitaire';
    const dealPileEl = document.createElement('div');
    dealPileEl.classList.add('deck__pile');
    dealPileEl.id = 'js-deck-pile';
    const dealEl = document.createElement('div');
    dealEl.classList.add('deck__deal');
    dealEl.id = 'js-deck-deal';
    const finishContainerEl = document.createElement('div');
    finishContainerEl.classList.add('finish-deck');
    finishContainerEl.id = 'js-finish';
    const deskContainerEl = document.createElement('div');
    deskContainerEl.classList.add('board-deck');
    deskContainerEl.id = 'js-board';
    const resetEl = document.createElement('button');
    resetEl.classList.add('new-game');
    resetEl.id = 'js-reset';
    resetEl.textContent = 'New Game';
    const deck = document.createElement('div');
    deck.classList.add('deck');

    const deckPileEl = dealPileEl;

    gameEl.append(finishContainerEl)
    gameEl.append(deskContainerEl)
    gameEl.append(deck)
    deck.append(dealPileEl)
    deck.append(dealEl)
